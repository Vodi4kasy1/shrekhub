...
local Win = loadstring(Something)():Window("Иди нахуй ваще", "Подзалупная игра")
...
Credits:Button("Кредиты у твоей семьи ебанаь", function()
    setclipboard("кредит")
end)

Credits:Button("кредит", function()
    setclipboard("кредит")
end)
